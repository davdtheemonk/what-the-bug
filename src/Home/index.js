...
React.useEffect(()=>{
  ...
  function timeout(delay: number) {
    ...
    return(
      ...
      <script data-name="BMC-Widget" data-cfasync="false" src="https://cdnjs.buymeacoffee.com/1.0.0/widget.prod.min.js" data-id="mugalladavG" data-description="Support me on Buy me a coffee!" data-message="Buy me a coffee :)" data-color="#5F7FFF" data-position="Right" data-x_margin="18" data-y_margin="18"></script>
      ...
      >
        ...
        <img className="img-avatar" src="/assets/avatar.jpg"></img>
            ...
            Hello!! <b>Am David,am a Computer Science student</b>.Check out the learning resources on <b>TALK PYTHON</b> on <b><i>introductory python</i></b> and <b><i>python for data science</i></b>.To publish your article email me mugalladave@gmail.com .
            </div>
          </Typography>
        </DialogContent>
      </BootstrapDialog>
